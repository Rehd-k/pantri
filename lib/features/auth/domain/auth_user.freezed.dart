...
mixin _$AuthUser {
 ...
 String? get companyInviteCode; String? get businessName; String? get fleetName; String? get employeeId; String? get verificationStatus; String? get phone;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String firstName,  String lastName, @JsonKey(fromJson: UserRole.fromApi, toJson: _roleToJson)  UserRole role, @JsonKey(fromJson: UserStatus.fromApi, toJson: _statusToJson)  UserStatus status,  String? employerId,  String? employerName,  String? employerInviteCode,  String? companyId,  String? companyName,  String? companyInviteCode,  String? businessName,  String? fleetName,  String? employeeId,  String? verificationStatus,  String? phone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthUser() when $default != null:
return $default(_that.id,_that.email,_that.firstName,_that.lastName,_that.role,_that.status,_that.employerId,_that.employerName,_that.employerInviteCode,_that.companyId,_that.companyName,_that.companyInviteCode,_that.businessName,_that.fleetName,_that.employeeId,_that.verificationStatus,_that.phone);case _:
  return orElse();
