...
class _MarketplaceCmsSection extends StatelessWidget {
  const _MarketplaceCmsSection();
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AppCard(
          onTap: () => context.router.push(const AdminCategoriesRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(AdminSubcategoriesRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(const AdminProductsRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(const AdminBannersRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(const AdminPackagesRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(const AdminDiscountTiersRoute()),
          child: Row(
            children: [
              Icon(
        ...
        AppCard(
          onTap: () =>
              context.router.push(const AdminDeliverySettingsRoute()),
          child: Row(
            children: [
              Icon(
        ...
        const SizedBox(height: AppSpacing.md),
        AppCard(
          onTap: () => context.router.push(const AdminCompaniesRoute()),
          child: Row(
            children: [
              Icon(
