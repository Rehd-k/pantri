...
as MeasureFamily?,recipeUnitId: freezed == recipeUnitId ? _self.recipeUnitId : recipeUnitId // ignore: cast_nullable_to_non_nullable
as String?,recipeUnit: freezed == recipeUnit ? _self.recipeUnit : recipeUnit // ignore: cast_nullable_to_non_nullable
as MeasureUnit?,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$MeasureUnitCopyWith<$Res>? get recipeUnit {
    if (_self.recipeUnit == null) {
    return null;
  }

  return $MeasureUnitCopyWith<$Res>(_self.recipeUnit!, (value) {
    return _then(_self.copyWith(recipeUnit: value));
  });
}/// Create a copy of MarketplaceProduct
/// with the given fields replaced by the non-null parameter values.
@override
...
@override final  String? recipeUnitId;
@override final  MeasureUnit? recipeUnit;
@override final  String name;
...
@override $MeasureFamilyCopyWith<$Res>? get measureFamily;@override $MeasureUnitCopyWith<$Res>? get recipeUnit;@override $CanonicalNutritionCopyWith<$Res> get nutrition;@override $RatingDistributionCopyWith<$Res> get ratingDistribution;
