...
mixin _$UpdateCategoryRequest {
 ...
 String? get name; String? get imageUrl; String? get accentColor; int? get sortOrder; bool? get isActive;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateCategoryRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.accentColor, accentColor) || other.accentColor == accentColor)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,imageUrl,accentColor,sortOrder,isActive);

@override
String toString() {
  return 'UpdateCategoryRequest(name: $name, imageUrl: $imageUrl, accentColor: $accentColor, sortOrder: $sortOrder, isActive: $isActive)';
}
...
@useResult
$Res call({
 String? name, String? imageUrl, String? accentColor, int? sortOrder, bool? isActive
});
...
/// Create a copy of UpdateCategoryRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? imageUrl = freezed,Object? accentColor = freezed,Object? sortOrder = freezed,Object? isActive = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? imageUrl,  String? accentColor,  int? sortOrder,  bool? isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateCategoryRequest() when $default != null:
return $default(_that.name,_that.imageUrl,_that.accentColor,_that.sortOrder,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? imageUrl,  String? accentColor,  int? sortOrder,  bool? isActive)  $default,) {final _that = this;
switch (_that) {
case _UpdateCategoryRequest():
return $default(_that.name,_that.imageUrl,_that.accentColor,_that.sortOrder,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? imageUrl,  String? accentColor,  int? sortOrder,  bool? isActive)?  $default,) {final _that = this;
switch (_that) {
case _UpdateCategoryRequest() when $default != null:
return $default(_that.name,_that.imageUrl,_that.accentColor,_that.sortOrder,_that.isActive);case _:
  return null;
...
class _UpdateCategoryRequest implements UpdateCategoryRequest {
  const _UpdateCategoryRequest({this.name, this.imageUrl, this.accentColor, this.sortOrder, this.isActive});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateCategoryRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.accentColor, accentColor) || other.accentColor == accentColor)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}
...
/// Create a copy of UpdateCategoryRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? imageUrl = freezed,Object? accentColor = freezed,Object? sortOrder = freezed,Object? isActive = freezed,}) {
